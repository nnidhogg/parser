#ifndef HOPPER_LIBS_CPP_INCLUDE_HOPPER_CPP_TOKEN_READER_HPP
#define HOPPER_LIBS_CPP_INCLUDE_HOPPER_CPP_TOKEN_READER_HPP
...
{
/**
 * @brief Turns a munch::core::Lexer into a one-token-lookahead stream of expression tokens.
 *
 * Skips whitespace and newline trivia transparently; callers only ever see meaningful tokens.
 */
class Token_reader
{
public:
...
#endif // HOPPER_LIBS_CPP_INCLUDE_HOPPER_CPP_TOKEN_READER_HPP
